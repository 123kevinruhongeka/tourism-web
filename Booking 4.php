...
<h1>Adventure Country Side Of Rwanda, Lake Kivu Beach And Cannopy Beach.
 </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="https://triprex.egenslab.com"> Home </a></li><li class="active">Adventure Country Side Of Rwanda, Lake Kivu Beach And Cannopy Beach.</li></ul> </div>
</div>
</div>
</div>
</div>
...
<img loading="lazy" width="1320" height="650" src="assets/images/Kivu.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" decoding="async" srcset="assets/images/Kivu 1.jpg 1320w, assets/images/Kivu 2.jpg 300w, assets/images/Kivu 3.jpg 600w, assets/images/Kivu 4.jpg 768w, assets/images/Kivu 5.jpg 1024w" sizes="(max-width: 1320px) 100vw, 1320px"> <a data-fancybox="gallery-01" href="assets/images/akagera lake.jpg"><i class="bi bi-eye"></i></a>
</div>
</div>
...
<img src="akagera/mount.jpg" alt="picture"> <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
</div>
</div>
<div class="col-6">
<div class="gallery-img-wrap active">
<img src="akagera/Nyungwe.jpg" alt="banner-image">
...
<ul>
<li><i class="bi bi-check-lg"></i>	Guiding fees</li>
<li><i class="bi bi-check-lg"></i> 	Nine  nights’ accommodation</li>
<li><i class="bi bi-check-lg"></i> A professional driver/guide </li>
<li><i class="bi bi-check-lg"></i> 	Transportation in Land cruiser</li>
<li><i class="bi bi-check-lg"></i> 	All entrance fees (All activities to be done)</li>
<li><i class="bi bi-check-lg"></i>	Pick up and drop off </li>
</ul>
<ul class="exclud">
<li><i class="bi bi-x-lg"></i> 	Additional accommodation before and at the end of the tour</li>
<li><i class="bi bi-x-lg"></i> 	Alcoholic drinks/spirits</li>
<li><i class="bi bi-x-lg"></i> All meals 	</li>
<li><i class="bi bi-x-lg"></i> 	Laundry</li>
<li><i class="bi bi-x-lg"></i> 	Personal Insurance </li>
<li><i class="bi bi-x-lg"></i> Personal items (Souvenirs, travel insurance, visa fee, tips, etc)</li>
<li><i class="bi bi-x-lg"></i> International flights (From/to home)</li>
</ul>
</div>
<div class="highlight-tour mb-20">
<h4>Highlights of the Tour</h4>
<ul>
<li><span><i class="bi bi-check"></i></span> Culture tours</li>
<li><span><i class="bi bi-check"></i></span> Hiking and visit island </li>
<li><span><i class="bi bi-check"></i></span> Gorilla trekking </li>
<li><span><i class="bi bi-check"></i></span> Chimpanzee</li>
<li><span><i class="bi bi-check"></i></span> Boat trips </li>
<li><span><i class="bi bi-check"></i></span> Museums </li>
<li><span><i class="bi bi-check"></i></span> Kigali City tour</li>
<li><span><i class="bi bi-check"></i></span> Game driver  </li>
<li><span><i class="bi bi-check"></i></span> Fishing if applicable. </li>
</ul>
</div>
<h4>Itinerary</h4>
...
<span>Day 01 :</span>Greetings and Briefing of the Trip </button>
</h2>
<div id="collapse0" class="accordion-collapse collapse show" aria-labelledby="heading0" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>You will be met and greeted by your trip guide and he/she will brief you on your Safari and overnight stay in Kigali and relax at your Hotel/Place</p>
<ul class="exclud">
...
<span>Day 02 :</span>Kigali City Tour and overnight in Musanze </button>
</h2>
<div id="collapse1" class="accordion-collapse collapse " aria-labelledby="heading1" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>In the morning after breakfast, you are going to see Kigali, Capital of Rwanda.
	Start the city tour by visiting museums, markets, Mount Kigali and Gisozi memorial site for learning more about genocide against Tutsi of 1994, and campaign against genocide. We drive for 2 hours in the north of Rwanda and overnight in Musanze	
	</p>
<ul class="exclud">
<li><i class="bi bi-check-lg"></i> Admire Big Ben, Buckingham Palace And St Paul’s Cathedral</li>
<li><i class="bi bi-check-lg"></i> Chance To Spot Prominent Landmarks Of The City</li>
...
<span>Day 03 :</span> Kigali - Volcanoes National Park 

</button>
</h2>
<div id="collapse2" class="accordion-collapse collapse " aria-labelledby="heading2" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>Early in the morning after breakfast, you will be transferred to Volcanoes National Park headquarters for your gorilla trekking. You will arrive at the main office at 7:30 am for a short briefing and coffee break before going on your trek. 
	Return at lunchtime over night at mount gorilla view lodge 
...
<span>Day 04 :</span>Volcanoes National Park – Rubavu
</h2>
<div id="collapse3" class="accordion-collapse collapse " aria-labelledby="heading3" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>In the morning after breakfast, you are going to see community activities in gorilla guardian village Eight different types of traditional dances by all community categories; men, women, youths and the children, and other local and traditional musical instruments also Visiting a local traditional healer to hear about the different medicinal trees, shrubs, grass and their traditional medicinal uses and how they are administered to local patients. Visit traditional clinics and pharmacies, the elderly and hear their interesting stories of pre and post
	and then Drive to the Lake Kivu in western of Rwanda. Check in the hotel and relax on the beach, and at the evening time do the boat ride with the fishermen and overnight in Rubavu.
	Overnight Kivu Galax hotel 	
	</p>
<ul class="exclud">
</ul>
</div>
...
<span>Day 05:</span>Full day in Rubavu visiting hot spring </button>
</h2>
<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>  The best weather is almost always early morning and often later in the afternoon. During wet seasons late morning is also usually fine. However, it is sometimes windy from about 10:30 to 14:30 in the dry seasons and thunderstorms sometimes affect afternoon trips in the wet seasons.  
	</p>
<ul class="exclud">
</ul>
</div>
...
<h2 class="accordion-header" id="heading4">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
<span>Day 06:</span> Rubavu - Rusizi</button>
</h2>
<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>Early in the morning, you will be heading to the west-southern of Rwanda, with an option of the tea with farmers. Stopover in Kibuye will award you the views of the Lake and Lunch time. Along the way, you will enjoy the thousands of beautiful green hills that make up our country as well as views of Kivu Lake. Visit environmental museums at Lake Kivu in the Western Province, the building consists of two floors with a traditional herbal medicine garden based on rooftop. It is the first and only environment museum on the continent that exhibits energy sources both renewable and none renewable., and after, enjoy the Lake Kivu by motorboat ride to Islands to see velvet monkeys and bats on the Napoleon Island and a short walk to Peace Island before continue our way to Rusizi 
	overnight kivu marina bay hotel   
	</p>
<ul class="exclud">
</ul>
</div>
...
<div class="accordion-item">
	<h2 class="accordion-header" id="heading4">
	<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
	<span>Day 07:</span>Chimpanzee trekking  </button>
	</h2>
	<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
	<div class="accordion-body">
	<p> After your early breakfast, you will enter the Nyungwe forest to trek for chimpanzee. A walk into the forest with knowledgeable guides well versed in botany, ornithology, and interspecies relationships will be a whole new learning experience for you. You will return to the guest house for lunch overnight kivu marina bay hotel  .
		</p>
	<ul class="exclud">
	</ul>
	</div>
	...
	<div class="accordion-item">
		<h2 class="accordion-header" id="heading4">
		<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
		<span>Day 08:</span>Canopy in Nyungwe National parks</button>
		</h2>
		<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
		<div class="accordion-body">
		<p> Morning after break fast .  the canopy walkway provides an exhilarating perspective on the ancient treetops and wildlife.
	...
	<div class="accordion-item">
		<h2 class="accordion-header" id="heading4">
		<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
		<span>Day 09:</span>Nyungwe – Huye - Kigali</button>
		</h2>
		<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
		<div class="accordion-body">
		<p>After early morning breakfast, you will drive going out the Nyungwe Forest. On the way, you will visit Ethnographic Museum of Butare , Nyanza King’s Palace in Nyanza build in 1934. Nyanza was the capital of the ancient Rwanda Kingdom before the arrival of the Europeans. Afterwards, we drive you in Kigali and overnight in Kigali. 			
			</p>
		<ul class="exclud">
		</ul>
		</div>
