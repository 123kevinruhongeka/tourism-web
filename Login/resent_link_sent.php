<html lang="en-US"><head>
    ...
    <link rel="stylesheet" id="egns-theme-css" href="https://triprex.b-cdn.net/wp-content/themes/triprex/style.css?ver=56" type="text/css" media="all">
    ...
    /* <![CDATA[ */
    var userSettings = {"url":"\/","uid":"0","time":"1727097246","secure":"1"};
    /* ]]> */
    </script>
    ...
    <div class="swiper-wrapper" id="swiper-wrapper-f13b640cf68b41fa" aria-live="off" style="transition-duration: 1500ms; transform: translate3d(-494px, 0px, 0px);">
    ...
    <div class="destination-sidebar-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f13b640cf68b41fa">
    ...
    <div class="destination-sidebar-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-f13b640cf68b41fa">
    <svg xmlns="http://www.w3.org/2000/svg" width="53" height="13" viewBox="0 0 53 13">
    ...
    Password reset email has been sent. </div>
    ...
    </div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off"></label><input type="hidden" name="_mc4wp_timestamp" value="1727097247"><input type="hidden" name="_mc4wp_form_id" value="233"><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1"><div class="mc4wp-response"></div></form> <img src="https://triprex.b-cdn.net/wp-content/themes/triprex/assets/img/home1/banner3-vector1.png" alt="vector1" class="vector1">
