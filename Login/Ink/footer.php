...
<footer class="footer-section newsletter-exists th-background-image">
    ...
    <div id="nav_menu-3" class="footer-widget widget_nav_menu"><div class="widget-title"><h5>Quick Link</h5></div><div class="menu-footer-menu-container"><ul id="menu-footer-menu" class="menu"><li id="menu-item-96" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-16 current_page_item menu-item-96"><a href="https://triprex.egenslab.com/about/" aria-current="page">About Us</a></li>
    ...
    <p>©Copyright 2024 ACROSS AFRICA JOURNEY | Design By <a href="https://www.instagram.com/ar_no_uld/">ArnouldIshimwe</a></p>
