...
<div class="menu-main-menu-container"><ul id="menu-main-menu" class="menu-list"><li id="menu-item-68" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children menu-item-68"><a href="\webpage\index.php">Home</a></i></li>
<li id="menu-item-69" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-69"><a href="\webpage\about.php">About</a><i class="bi bi-plus dropdown-icon"></i></li>
<li id="menu-item-93" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-93"><a href="\webpage\tours.php">Tours</a><!--<i class="bi bi-plus dropdown-icon"></i>-->
<!--<ul class="sub-menu">
...
<li id="menu-item-94" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-94"><a href="\webpage\destination.php">Destination</a><!--<i class="bi bi-plus dropdown-icon"></i>-->
<!--<ul class="sub-menu">
...
<ul class="sub-menu">
<li id="menu-item-173" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-173"><a href="\webpage\intern.php">Internship Program</a><i class="bi bi-plus dropdown-icon"></i></li>
<li id="menu-item-111" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-111"><a href="\webpage\Trainning.php">Training Program</a><i class="bi bi-plus dropdown-icon"></i></li>
<li id="menu-item-170" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-170"><a href="\webpage\workshop.php">Workshop</a><i class="bi bi-plus dropdown-icon"></i></li>
<li id="menu-item-171" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-171"><a href="\webpage\bootcamp.php">BootCamp program</a><i class="bi bi-plus dropdown-icon"></i></li>
...
<li id="menu-item-72" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-72"><a href="\webpage\contact.php">Contact</a><i class="bi bi-plus dropdown-icon"></i></li>
</ul></div> <div class="topbar-right d-lg-none d-block">
<a href="\webpage\Login\dashboard.php" class="modal-btn header-cart-btn" title="Login / Register">
...
<h6><a href="tel:+<?php echo $contact_r['pn1'] ?>">+<?php echo $contact_r['pn1'] ?></a></h6>
</div>
</div>
</div>
...
<a href="\webpage\Login\dashboard.php" title="Login / Register">
