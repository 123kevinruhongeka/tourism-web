<html lang="en-US"><head>
    ...
    <link rel="stylesheet" id="egns-theme-css" href="https://triprex.b-cdn.net/wp-content/themes/triprex/style.css?ver=90" type="text/css" media="all">
    ...
    <script type="text/javascript" src="https://triprex.egenslab.com/wp-content/plugins/woocommerce/assets/js/frontend/lost-password.min.js?ver=9.3.2" id="wc-lost-password-js" defer="defer" data-wp-strategy="defer"></script>
    <script type="text/javascript" id="utils-js-extra">
    /* <![CDATA[ */
    var userSettings = {"url":"\/","uid":"0","time":"1727097053","secure":"1"};
    /* ]]> */
    </script>
    ...
    <body class="page-template-default page page-id-12 wp-embed-responsive theme-triprex woocommerce-account woocommerce-page woocommerce-lost-password woocommerce-js elementor-default elementor-kit-7" itemtype="https://schema.org/WebPage">
    ...
    <div class="swiper-wrapper" id="swiper-wrapper-1735d5952e84549c" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-494px, 0px, 0px); transition-delay: 0ms;">
    ...
    <div class="destination-sidebar-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-1735d5952e84549c">
    ...
    <div class="destination-sidebar-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-1735d5952e84549c">
    <svg xmlns="http://www.w3.org/2000/svg" width="53" height="13" viewBox="0 0 53 13">
    ...
    <li id="menu-item-91" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current_page_ancestor menu-item-has-children menu-item-91"><a href="https://triprex.egenslab.com/pages/">Pages</a><i class="bi bi-plus dropdown-icon"></i>
    <ul class="sub-menu">
    ...
    <li id="menu-item-2433" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-2433"><a href="/shop">Shop</a><i class="bi bi-plus dropdown-icon"></i>
    <ul class="sub-menu">
    ...
    <li id="menu-item-85" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-12 current_page_item menu-item-85"><a href="https://triprex.egenslab.com/my-account/" aria-current="page">My account</a><i class="bi bi-plus dropdown-icon"></i></li>
    </ul>
    </li>
    ...
    <input type="hidden" id="woocommerce-lost-password-nonce" name="woocommerce-lost-password-nonce" value="f24039dd3c"><input type="hidden" name="_wp_http_referer" value="/my-account/lost-password/">
    </form>
    </div> </div> 
    </div>
    </div> 
    ...
    /* <![CDATA[ */
    var wpApiSettings = {"root":"https:\/\/triprex.egenslab.com\/wp-json\/","nonce":"f19dc369b4","versionString":"wp\/v2\/"};
    /* ]]> */
    </script>
