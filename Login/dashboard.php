...
if (!isset($_SESSION['user_id'])) {
    header("Location: my-account.php"); // Redirect to login if not logged in
    exit();
}
?>
...
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"98","time":"1727100457","secure":"1"};
/* ]]> */
</script>
...
<body class="page-template-default page page-id-12 logged-in wp-embed-responsive theme-triprex woocommerce-account woocommerce-page woocommerce-js elementor-default elementor-kit-7" itemtype="https://schema.org/WebPage">
...
<div class="swiper-wrapper" id="swiper-wrapper-557bfbf8b347fff8" aria-live="off" style="transition-duration: 1500ms; transform: translate3d(-494px, 0px, 0px);">
...
<div class="swiper-slide swiper-slide-prev" role="group" aria-label="5 / 5" data-swiper-slide-index="4" style="width: 232px; margin-right: 15px;">
<div class="destination-card2">
...
<div class="swiper-slide swiper-slide-active" style="width: 232px; margin-right: 15px;" role="group" aria-label="1 / 5" data-swiper-slide-index="0">
<div class="destination-card2">
...
<div class="destination-sidebar-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-557bfbf8b347fff8">
...
<div class="destination-sidebar-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-557bfbf8b347fff8">
<svg xmlns="http://www.w3.org/2000/svg" width="53" height="13" viewBox="0 0 53 13">
...
<h1>
My account </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="\webpage\index.php"> Home </a></li><li class="active">My account</li></ul> </div>
</div>
</div>
</div>
</div>
...
<p>
Hello <strong>arnova ishimwe</strong> (not <strong>arnova ishimwe</strong>? <a href="logout.php">Log out</a>)</p>
<p>
From your account dashboard you can view your <a href="#">recent orders</a>, manage your <a href="#">shipping and billing addresses</a>, and <a href="#">edit your password and account details</a>.</p>
</div>
</div> </div> 
</div>
</div> 
...
</div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off"></label><input type="hidden" name="_mc4wp_timestamp" value="1727100458"><input type="hidden" name="_mc4wp_form_id" value="233"><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1"><div class="mc4wp-response"></div></form> <img src="https://triprex.b-cdn.net/wp-content/themes/triprex/assets/img/home1/banner3-vector1.png" alt="vector1" class="vector1">
...
/* <![CDATA[ */
var wpApiSettings = {"root":"https:\/\/triprex.egenslab.com\/wp-json\/","nonce":"423c6a1bb8","versionString":"wp\/v2\/"};
/* ]]> */
</script>
