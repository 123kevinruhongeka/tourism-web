...
<title>My account – AcrossAfricajourney</title>
...
<link rel="stylesheet" id="select2-css" href="https://triprex.egenslab.com/wp-content/plugins/woocommerce/assets/css/select2.css?ver=8.8.2" type="text/css" media="all">
...
<link rel="stylesheet" id="egns-theme-css" href="https://triprex.b-cdn.net/wp-content/themes/triprex/style.css?ver=31" type="text/css" media="all">
...
<script type="text/javascript" src="https://triprex.egenslab.com/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min.js?ver=1.0.9-wc.8.8.2" id="selectWoo-js" defer="defer" data-wp-strategy="defer"></script>
...
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"0","time":"1714670971","secure":"1"};
/* ]]> */
</script>
...
<![endif]-->
<link rel="https://api.w.org/" href="https://triprex.egenslab.com/wp-json/"><link rel="alternate" type="application/json" href="https://triprex.egenslab.com/wp-json/wp/v2/pages/12"><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://triprex.egenslab.com/xmlrpc.php?rsd">
...
<link rel="alternate" type="application/json+oembed" href="https://triprex.egenslab.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftriprex.egenslab.com%2Fmy-account%2F">
<link rel="alternate" type="text/xml+oembed" href="https://triprex.egenslab.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftriprex.egenslab.com%2Fmy-account%2F&amp;format=xml">
...
<body class="page-template-default page page-id-12 wp-embed-responsive theme-triprex woocommerce-account woocommerce-page woocommerce-js elementor-default elementor-kit-7" itemtype="https://schema.org/WebPage">
...
<div class="swiper-wrapper" id="swiper-wrapper-b587da1093ae770b9" aria-live="off" style="transition-duration: 1500ms; transform: translate3d(-494px, 0px, 0px);">
...
<div class="destination-sidebar-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-b587da1093ae770b9">
...
<div class="destination-sidebar-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-b587da1093ae770b9">
<svg xmlns="http://www.w3.org/2000/svg" width="53" height="13" viewBox="0 0 53 13">
...
<form action="login.php" class="woocommerce-form woocommerce-form-login login" method="post">
<h2>Login</h2>
...
<input type="hidden" id="" name="woocommerce-login-nonce" value=""><input type="hidden" name="" value="/my-account/"> <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Log in">Log in</button>
</p>
<p class="woocommerce-LostPassword lost_password">
<a href="https://triprex.egenslab.com/my-account/lost-password/">Lost your password?</a>
</p>
</form>
</div>
<div class="u-column2 col-2">
<form action="register.php" method="post" class="woocommerce-form woocommerce-form-register register">
<h2>Register</h2>
<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
...
<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
<label for="password">Password&nbsp;<span class="required">*</span></label>
<span class="password-input"><input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password" id="password" autocomplete="new-password"><span class="show-password-input"></span></span>
</p>
<wc-order-attribution-inputs><input type="hidden" name="wc_order_attribution_source_type" value="referral"><input type="hidden" name="wc_order_attribution_referrer" value="http://localhost/"><input type="hidden" name="wc_order_attribution_utm_campaign" value="(none)"><input type="hidden" name="wc_order_attribution_utm_source" value="localhost"><input type="hidden" name="wc_order_attribution_utm_medium" value="referral"><input type="hidden" name="wc_order_attribution_utm_content" value="/"><input type="hidden" name="wc_order_attribution_utm_id" value="(none)"><input type="hidden" name="wc_order_attribution_utm_term" value="(none)"><input type="hidden" name="wc_order_attribution_session_entry" value="https://localhost/webpage/Login/my-account.php/"><input type="hidden" name="wc_order_attribution_session_start_time" value="2024-05-02 17:29:33"><input type="hidden" name="wc_order_attribution_session_pages" value="1"><input type="hidden" name="wc_order_attribution_session_count" value="12"><input type="hidden" name="wc_order_attribution_user_agent" value="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36"></wc-order-attribution-inputs><div class="woocommerce-privacy-policy-text"><p>Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <a href="#" class="woocommerce-privacy-policy-link" target="_blank">privacy policy</a>.</p>
</div>
<p class="woocommerce-form-row form-row">
<input type="hidden" id="woocommerce-register-nonce" name="woocommerce-register-nonce" value=""><input type="hidden" name="" value="/my-account/"> <button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit">Register</button>
</p>
</form>
</div>
</div>
...
</div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off"></label><input type="hidden" name="_mc4wp_timestamp" value="1714670971"><input type="hidden" name="_mc4wp_form_id" value="233"><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1"><div class="mc4wp-response"></div></form> <img src="https://triprex.b-cdn.net/wp-content/themes/triprex/assets/img/home1/banner3-vector1.png" alt="vector1" class="vector1">
...
/* <![CDATA[ */
var wpApiSettings = {"root":"https:\/\/triprex.egenslab.com\/wp-json\/","nonce":"885de4edab","versionString":"wp\/v2\/"};
/* ]]> */
</script>
