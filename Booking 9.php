...
<h1>Kigali to bush bliss tour.
 </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="index.html"> Home </a></li><li class="active">Kigali to bush bliss tour.
</li></ul> </div>
</div>
</div>
</div>
...
<img loading="lazy" width="1320" height="650" src="akagera/akager.webp" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" decoding="async" srcset="akagera/akager 1.webp 1320w, akagera/akager 2.webp 300w, akagera/akager 3.webp 600w, akagera/akager 4.webp 768w, akagera/akager 5.webp 1024w" sizes="(max-width: 1320px) 100vw, 1320px"> <a data-fancybox="gallery-01" href="assets/images/akagera lake.jpg"><i class="bi bi-eye"></i></a>
</div>
</div>
...
<img src="akagera/akagera lodge.jpeg" alt="picture"> <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
</div>
</div>
<div class="col-6">
<div class="gallery-img-wrap active">
<img src="akagera/girrafe.jpg" alt="banner-image">
...
<h3><span>$649<del>$710</del></span>/</h3>
...
<p>Check out at your hotel and set off for Akagera National Park. Stop on route at Imigongo art center and restaurant for coffee break, after continue driving towards the park reception 08h00 am Arrive at the park headquarters for tour formalities and briefing. After breakfast immediately set off for your game drive where you will be able to spot all mammals and an opportunity to spot a variety of wild animals such as elephants, buffalo, lions, giraffes, gazelle, impala, baboon, oribi, and Burch ell’s zebra, topis, bush back, leopard, and bushbuck. You will also see crocodiles and hippos, together with a large concentration of birdlife, with over 525 identified species. Rejoin your driver guide and proceed for a game viewing drive in the park via northern part and have a Picnic lunch, Exit the park in the late afternoon and drive back to Kigali at your hotel or the Kigali International Airport.  
</p>
...
<ul>
<li><i class="bi bi-check-lg"></i> Park fees(For non-residents)</li>
<li><i class="bi bi-check-lg"></i> All activities(Unless labeled as optional) </li>
<li><i class="bi bi-check-lg"></i> A professional driver/guide </li>
<li><i class="bi bi-check-lg"></i> All transportation(Unless labeled as optional) </li>
<li><i class="bi bi-check-lg"></i> All Taxes/VAT </li>
<li><i class="bi bi-check-lg"></i> Roundtrip airport transfer </li>
<li><i class="bi bi-check-lg"></i> Meals</li>
<li><i class="bi bi-check-lg"></i> Water</li>
</ul>
<ul class="exclud">
<li><i class="bi bi-x-lg"></i> 	International flights(From/to home)</li>
<li><i class="bi bi-x-lg"></i> Porterage</li>
<li><i class="bi bi-x-lg"></i> Rescue fee </li>
<li><i class="bi bi-x-lg"></i> Climbing gear	 </li>
<li><i class="bi bi-x-lg"></i> 	Government imposed increase of taxes and/or park fees </li>
<li><i class="bi bi-x-lg"></i> 	Tips</li>
...
<p>Pick up at your hotel in Kigali and drive to the park headquarters for Bisoke Volcano Hiking Park Briefings, which has a height of 3711 m above sea level. It takes 5 – 7 hours after returning for Lunch and transfer to Kigali.
</p>
<ul class="exclud">
