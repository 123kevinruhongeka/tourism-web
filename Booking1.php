...
<h1>
Discover Serenity, Exploration, and Enlightenment. </h1>
...
<span>Day 01 :</span> Admire Big Ben, Buckingham Palace And St Paul’s Cathedral </button>
</h2>
...
<span>Day 02 :</span> Adventure Beggins </button>
</h2>
...
<span>Day 03 :</span> Historical Tour </button>
</h2>
...
<input class="form-check-input" type="radio" name="booking_date" id="checkIn0" value="25 February, 2024 to 29 February, 2024" checked="">
...
<div class="form-check mb-25">
<input class="form-check-input" type="radio" name="booking_date" id="checkIn1" value="05 February, 2024 to 10 February, 2024">
...
<input class="form-check-input" type="radio" name="booking_date" id="Custom" value="22 May, 2024">
<label class="form-check-label" for="Custom">
</label>
<span class="form-group">
<input type="text" readonly="" name="daterange" placeholder="22 May, 2024">
