...
<p>
	This 13-day trip highlights Rwanda’s best experiences, combining stunning nature, wildlife, and adventure activities for the ultimate Rwandan safari experience. You will visit three National Parks (Nyungwe Forest, Volcanoes & Akagera), trek a number of primates including two great apes, traverse hillsides, forests, and bodies of water & have the chance to try to find the big 5 animals.		
</p>
...
<ul>
<li><i class="bi bi-check-lg"></i>Emergence evacuation fees</li>
<li><i class="bi bi-check-lg"></i>Ground transport in a 4WD Jeep</li>
<li><i class="bi bi-check-lg"></i> Bottled water, boat ride</li>
<li><i class="bi bi-check-lg"></i>Park entrance fees (Gorillas, Chimpanzees, and Golden Monkey Permits)</li>
<li><i class="bi bi-check-lg"></i>Game drive, accommodation based on FB</li>
<li><i class="bi bi-check-lg"></i>Service of an English-speaking driver guide</li>
<li><i class="bi bi-check-lg"></i>	Ground transportation </li>
<li><i class="bi bi-check-lg"></i> Pick up and drop off after the trip</li>
<li><i class="bi bi-check-lg"></i>All mentioned activities. </li>
</ul>
<ul class="exclud">
<li><i class="bi bi-x-lg"></i> Extras accommodation i.e. drinks, telephone, laundry etc.</li>
<li><i class="bi bi-x-lg"></i> 	Tips to porters and driver/ guide</li>
<li><i class="bi bi-x-lg"></i> Insurance and flights tickets</li>
</ul>
</div>
...
<p>You will be met and greeted by your Golden Rwanda Safaris driver-guide upon your arrival at Kigali International Airport. He or she will brief you on your safari before transferring you to your hotel for your overnight stay in Kigali at the Governor’s Residence House or Kigali Serena Hotel.
	</p>
<ul class="exclud">
...
<li><i class="bi bi-check-lg"></i> Admire Big Ben, Buckingham Palace And St Paul’s Cathedral</li>
<li><i class="bi bi-check-lg"></i> Chance To Spot Prominent Landmarks Of The City</li>
</ul>Start the day with a delicious breakfast at the hotel.
