...
<link rel="alternate" type="application/rss+xml" title="TripRex » Tours Feed" href="https://triprex.egenslab.com/tour/feed/">
...
<link rel="stylesheet" id="egns-theme-css" href="https://triprex.b-cdn.net/wp-content/themes/triprex/style.css?ver=72" type="text/css" media="all">
...
<link rel="https://api.w.org/" href="https://triprex.egenslab.com/wp-json/"><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://triprex.egenslab.com/xmlrpc.php?rsd">
...
<body class="archive post-type-archive post-type-archive-tours wp-embed-responsive theme-triprex woocommerce-js elementor-default elementor-kit-7" itemtype="https://schema.org/WebPage">
...
<div class="swiper-wrapper" id="swiper-wrapper-5360a62fa6662a1e" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-494px, 0px, 0px); transition-delay: 0ms;">
...
<div class="destination-sidebar-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-5360a62fa6662a1e">
...
<div class="destination-sidebar-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-5360a62fa6662a1e">
<svg xmlns="http://www.w3.org/2000/svg" width="53" height="13" viewBox="0 0 53 13">
...
<h1>
Tours </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="index.php"> Home </a></li><li class="active">Tours</li></ul> </div>
</div>
</div>
</div>
</div>
...
<div id="slider-range" class="price-filter-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content">
<div class="mt-5 d-flex justify-content-between gap-4">
<input type="number" min="160" max="760" oninput="validity.valid||(value='160');" id="min_price" class="price-range-field">
<input type="number" min="160" max="760" oninput="validity.valid||(value='760');" id="max_price" class="price-range-field">
</div>
...
<li>
<label for="Sweden">
<input type="radio" id="Sweden" name="destination" class="radioBtnClass" value="957"> Sweden <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Japan">
<input type="radio" id="Japan" name="destination" class="radioBtnClass" value="956"> Japan <span class="checkmark"></span>
</label>
</li>
<li>
<label for="India">
<input type="radio" id="India" name="destination" class="radioBtnClass" value="955"> India <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Brazil">
<input type="radio" id="Brazil" name="destination" class="radioBtnClass" value="954"> Brazil <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Australia">
<input type="radio" id="Australia" name="destination" class="radioBtnClass" value="953"> Australia <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Spain">
<input type="radio" id="Spain" name="destination" class="radioBtnClass" value="949"> Spain <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Italy">
<input type="radio" id="Italy" name="destination" class="radioBtnClass" value="948"> Italy <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Indonesia">
<input type="radio" id="Indonesia" name="destination" class="radioBtnClass" value="947"> Indonesia <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Saudi Arab">
<input type="radio" id="Saudi Arab" name="destination" class="radioBtnClass" value="946"> Saudi Arab <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Switzerland">
<input type="radio" id="Switzerland" name="destination" class="radioBtnClass" value="945"> Switzerland <span class="checkmark"></span>
</label>
</li>
<li>
<label for="New York">
<input type="radio" id="New York" name="destination" class="radioBtnClass" value="944"> New York <span class="checkmark"></span>
</label>
</li>
<li>
<label for="Egypt">
<input type="radio" id="Egypt" name="destination" class="radioBtnClass" value="426"> Egypt <span class="checkmark"></span>
</label>
</li>
</ul>
</div>
<div class="single-widget mb-30">
<h5 class="widget-title">Tour Type</h5>
<ul class="category-list">
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="81">
<span class="checkmark"></span>
<a data-slug="adventure-tours">Adventure Tours</a>
</label>
</li>
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="85">
<span class="checkmark"></span>
<a data-slug="cultural-tours">Cultural Tours</a>
</label>
</li>
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="102">
<span class="checkmark"></span>
<a data-slug="group-tour">Group Tour</a>
</label>
</li>
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="82">
<span class="checkmark"></span>
<a data-slug="historical-tours">Historical Tours</a>
</label>
</li>
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="86">
<span class="checkmark"></span>
<a data-slug="honey-moon-tour">Honey moon Tour</a>
</label>
</li>
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="101">
<span class="checkmark"></span>
<a data-slug="luxury-tour">Luxury Tour</a>
</label>
</li>
<li>
<label class="containerss">
<input class="tourType" type="checkbox" value="83">
<span class="checkmark"></span>
<a data-slug="wildlife-safari">Wildlife &amp; Safari</a>
</label>
</li>
</ul>
</div>
...
<img src="https://triprex.egenslab.com/wp-content/plugins/triprex-core//inc/theme-options/images/sidebar/sidebar-pack.jpg" alt="card2-img">
...
<a href="/tour" class="secondary-btn2">View All Package</a>
</div>
</div>
</div>
</div> </div>
...
<p>Showing 1-6 of 12 Results</p> <div class="selector-and-grid">
<ul class="grid-view">
...
<div class="row gy-4" id="tourFilterData1">
<div class="col-md-6 item">
<?php 
    /*$tours_r = selectAll('tours_details');
    $path=TOURS_IMG_PATH;
    while($row = mysqli_fetch_assoc($tours_r)){
    echo<<<data
    <div class="package-card">
    <div class="package-card-img-wrap">
    <a href="$row[Booking]" class="card-img"><img src="$path$row[picture]" alt=""></a>
    <div class="batch">
    ...
    <div class="location-area"><ul class="location-list scrollTextAni"><li><a href="">KIGALI</a></li><li><a href="">MUSANZE</a></li><li><a href="">NYANZA</a></li><li><a href="">KIBUYE</a></li><li><a href="">GISENYI</a></li></ul></div> </div>
    <div class="card-content-bottom">
    <div class="price-area">
    <h6>Starting From:</h6>
    <span>&#36;$row[price]<del>&#36;$row[discount]</del></span> <p>TAXES INCL/PERS</p>
    </div>
    <a href="$row[Booking]" class="primary-btn2">Book a Trip <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
    ...
    $total_tours = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(*) as total FROM tours_details"));
    $total_pages = ceil($total_tours['total'] / $limit);

    // Fetch packages for the current page
    $tours_r = mysqli_query($con, "SELECT * FROM tours_details LIMIT $limit OFFSET $offset");
    $path = TOURS_IMG_PATH;
    ...
    while ($row = mysqli_fetch_assoc($tours_r)) {
        ...
        <div class="package-card">
            <div class="package-card-img-wrap">
                <a href="$row[Booking]" class="card-img" onclick="checkLoginAndBook(event)"><img src="$path$row[picture]" alt=""></a>
                <div class="batch">
                    <span class="date">$row[period] Days</span>
                    <div class="location">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                ...
                <div class="card-content-top">
                    ...
                    <div class="location-area">
                        <ul class="location-list scrollTextAni">
                            <li><a href="">KIGALI</a></li><li><a href="">MUSANZE</a></li><li><a href="">NYANZA</a></li><li><a href="">KIBUYE</a></li><li><a href="">GISENYI</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-content-bottom">
                    <div class="price-area">
                        <h6>Starting From:</h6>
                        <span>&#36;$row[price]<del>&#36;$row[discount]</del></span> 
                        <p>TAXES INCL/PERS</p>
                    </div>
                    <a href="$row[Booking]" class="primary-btn2" onclick="checkLoginAndBook(event)">Book a Trip</a>
                </div>
            </div>
        </div>
        </div><div class="col-md-6 item">
...
<div class="package-card">
<div class="package-card-img-wrap">
<a href="#" class="card-img"><img src="https://triprex.b-cdn.net/wp-content/uploads/2024/02/Tour-Package-11-650x450.webp" alt=""></a>
<div class="batch">
...
<div class="package-card-content">
<div class="card-content-top">
<h5><a href="#">Embark Tranquility, Adventure, And Spiritual.</a></h5>
<div class="location-area"><ul class="location-list scrollTextAni"><li><a href="#">Sea Beach</a></li><li><a href="#">Sajek Vally</a></li><li><a href="#">Saint Martin</a></li><li><a href="#">Khagrachori</a></li></ul></div> </div>
<div class="card-content-bottom">
<div class="price-area">
<h6>Starting From:</h6>
        ...
        <nav class="inner-pagination-area" id="tourPackagePagination">
            <ul class="pagination-list">
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    echo '<li><a class="'. ($i == $page ? 'active' : '') .'" href="?page=' . $i . '">' . sprintf("%02d", $i) . '</a></li>';
                }
                ?>
            </ul>
        </nav>
...
<nav class="inner-pagination-area" id="tourPackagePagination">
<ul class="pagination-list">
<li><a class="active" aria-current="page">01</a></li>
<li><a class="" href="https://triprex.egenslab.com/tour/page/2/">02</a></li>
<li><a class="next " href="https://triprex.egenslab.com/tour/page/2/"><b class="shop-pagi-btn"><i class="bi bi-chevron-right"></i></b></a></li>
</ul>
</nav>
</div>
</div>-->
...
</div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off"></label><input type="hidden" name="_mc4wp_timestamp" value="1713282478"><input type="hidden" name="_mc4wp_form_id" value="233"><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1"><div class="mc4wp-response"></div></form> <img src="https://triprex.b-cdn.net/wp-content/themes/triprex/assets/img/home1/banner3-vector1.png" alt="vector1" class="vector1">
...
document.addEventListener("DOMContentLoaded", function() {
    const loader = document.querySelector('.circle-loader1');
    const tourFilterData = document.querySelector('#tourFilterData1');
    ...
    function loadPage(url) {
        ...
        fetch(url)
            ...
            .then(data => {
                loader.style.display = 'none'; // Hide loader when content is loaded
                const parser = new DOMParser();
                const htmlDocument = parser.parseFromString(data, "text/html");
                
                // Replace the filtered tour packages content
                const newContent = htmlDocument.querySelector('#tourFilterData1').innerHTML;
                tourFilterData.innerHTML = newContent;
                
                // Replace pagination links with updated ones
                const newPagination = htmlDocument.querySelector('.pagination-list').innerHTML;
                document.querySelector('.pagination-list').innerHTML = newPagination;
    ...
    // Initially attach click events to pagination links
    attachPaginationEvents();
});
</script>
