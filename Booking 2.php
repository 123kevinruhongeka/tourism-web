...
<h1>Immersive Adventure Experience In The Volcanoes And Local Cuisine.
 </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="index.html"> Home </a></li><li class="active">Immersive Adventure Experience In The Volcanoes And Local Cuisine.</li></ul> </div>
</div>
</div>
</div>
</div>
...
<img loading="lazy" width="1320" height="650" src="akagera/kirunga.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" decoding="async" srcset="akagera/kirunga 1.jpg 1320w, akagera/kirunga 2.jpg 300w, akagera/kirunga 3.jpg 600w, akagera/kirunga 4.jpg 768w, akagera/kirunga 5.jpg 1024w" sizes="(max-width: 1320px) 100vw, 1320px"> <a data-fancybox="gallery-01" href="assets/images/akagera lake.jpg"><i class="bi bi-eye"></i></a>
</div>
</div>
...
<img src="akagera/car akagera.jpeg" alt="picture"> <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
</div>
</div>
<div class="col-6">
<div class="gallery-img-wrap active">
<img src="akagera/bisoke.jpeg" alt="banner-image">
...
<p>This tour will showcase one of the oldest rainforests in Africa Nyungwe, volcanoes national park as a home to endangered Mountain Gorillas, Kigali city tour as the cleanest, safest and greenest city in Africa, Lake Kivu as the biggest Lake in the country, King’s palace museum to highlight the Rwandan culture and history in one place, in other words this tour will summarize Rwanda in terms of Weather, region, people and culture. 
</p>
...
<ul>
<li><span><i class="bi bi-check"></i></span> Mountain gorilla trekking.</li>
...
<li><span><i class="bi bi-check"></i></span> Canopy walkway.</li>
<li><span><i class="bi bi-check"></i></span> Ndambarare Waterfall</li>
<li><span><i class="bi bi-check"></i></span> King’s palace museum.</li>
</ul>
</div>
<h4>Itinerary</h4>
...
<p>Meet and greet At Kigali International Airport and transfer to Musanze for hotel check-in and the night stay at hotel in Musanze</p>
<ul class="exclud">
...
<span>Day 02 :</span>: Gorilla Trekking in Volcanoes and transfer to Lake Kivu. </button>
</h2>
<div id="collapse1" class="accordion-collapse collapse " aria-labelledby="heading1" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>Wakeup to an early morning breakfast and report to the park headquarters for briefing and allocation of Gorilla trekking groups. Later, you will head into the cold and misty forested slopes of Virunga national park for your Gorilla trek. 
	The trek can be anywhere between 2 to 4 hours depending on the movement of the Gorillas and upon finding them, you will be allowed 1 hour to see and take photos after which you exit the forest. Meet your guide 
	
	Later you will depart from Musanze to the shore of Lake Kivu, check-in and the night stay at the hotel in Rubavu/ shore at Lake Kivu.
	</p>
<ul class="exclud">
<li><i class="bi bi-check-lg"></i> Admire Big Ben, Buckingham Palace And St Paul’s Cathedral</li>
<li><i class="bi bi-check-lg"></i> Chance To Spot Prominent Landmarks Of The City</li>
...
<span>Day 03 :</span> Boat ride at Lake Kivu and transfer to Nyungwe national park for canopy walk way visit.

</button>
</h2>
<div id="collapse2" class="accordion-collapse collapse " aria-labelledby="heading2" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>In morning after breakfast, ride the boat from the hotel for the lake exploration, island visit and drive from the hotel to Nyungwe national park for canopy-walk way, it is 4-5 hours’ worth drive while enjoying the scenic and windy road surrounded by the green endless rolling hills with aerial view of Lake Kivu not far from the road.
	Arrival at the park, check-in, and completing the park formalities including briefings then start the nature walk to the bridge. 
	In the evening, transfer to the hotel for the overnight stay. 
	</p>
<ul class="exclud">
</ul>
</div>
...
<span>Day 04 :</span>Nyungwe waterfall Visit and Drive back to Kigali

</button>
</h2>
<div id="collapse3" class="accordion-collapse collapse " aria-labelledby="heading3" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>Early morning after breakfast, check-out from the hotel and drive the Park reception for waterfall visit, later after the visit, we will drive back to Kigali. 
	On the way we will visit King’s palace museum to catch glimpse of Rwandan history and culture.
	
	Transfer to the hotel for dinner and night stay at the hotel in Kigali.Enjoying the night out at fancy restaurant. 
	</p>
<ul class="exclud">
</ul>
</div>
...
<span>Day 05:</span>Kigali City tour</button>
</h2>
<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>In the morning, after breakfast, pick up the guests from the hotel and then it will be the best time for a city sightseeing tour, including visiting the Kigali genocide memorial, the Campaign Against Genocide Museum, a local market for souvenirs shopping, Kigali city center, and more. After the city tour, we'll drive back to the hotel for the night stay.</p>
<ul class="exclud">
</ul>
</div>
</div>
...
<h2 class="accordion-header" id="heading4">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
<span>Day 06:</span>Drop-off to Kigali International Airport </button>
</h2>
<div id="collapse4" class="accordion-collapse collapse " aria-labelledby="heading4" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>In the morning after breakfast, will do the hotel check-out and drive to Kigali International Airport for departure.</p>
<ul class="exclud">
</ul>
</div>
</div>
