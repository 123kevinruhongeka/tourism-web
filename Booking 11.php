...
<h1>Gisenyi gateway tea and hotspring adventure
 </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="index.html"> Home </a></li><li class="active">Gisenyi gateway tea and hotspring adventure.
</li></ul> </div>
</div>
</div>
</div>
...
<h3><span>$590<del>$650</del></span>/</h3>
...
<p>Scenic journey from Kigali to Gisenyi, where adventure and relaxation await. Along the way, immerse yourself in Rwanda's rich tea culture with a visit to Pfunda Tea Estate, where you'll witness the art of tea cultivation and processing amidst lush greenery. Then, set sail on a mesmerizing boat tour on Lake Kivu, admiring its tranquil waters and picturesque surroundings. Cap off your day with a visit to the rejuvenating hot springs, indulging in their therapeutic waters amidst stunning natural beauty. Experience the perfect blend of exploration and serenity on this unforgettable journey from city to lakeside paradise.  
</p>
...
<ul>
<li><i class="bi bi-check-lg"></i> Transport</li>
<li><i class="bi bi-check-lg"></i> boat </li>
<li><i class="bi bi-check-lg"></i> Activities </li>
<li><i class="bi bi-check-lg"></i> Guiding </li>
<li><i class="bi bi-check-lg"></i> Water </li>
</ul>
<ul class="exclud">
<li><i class="bi bi-x-lg"></i> 	Lunch</li>
<li><i class="bi bi-x-lg"></i> Accomodation</li>
<li><i class="bi bi-x-lg"></i> Tips</li>
<li><i class="bi bi-x-lg"></i> Drinks and beverages</li>
</ul>
</div>
