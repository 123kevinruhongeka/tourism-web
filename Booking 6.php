...
<h1>A day tour at Kigali Historical sites and site seeing.
 </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="index.html"> Home </a></li><li class="active">A day tour at Kigali historical sites and site seeing.
</li></ul> </div>
</div>
</div>
</div>
...
<img loading="lazy" width="1320" height="650" src="akagera/kigali city.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" decoding="async" srcset="akagera/kigali city 1.jpg 1320w, akagera/kigali city 2.jpg 300w, akagera/kigali city 3.jpg 600w, akagera/kigali city 4.jpg 768w, akagera/kigali city 5.jpg 1024w" sizes="(max-width: 1320px) 100vw, 1320px"> <a data-fancybox="gallery-01" href="assets/images/akagera lake.jpg"><i class="bi bi-eye"></i></a>
</div>
</div>
...
<div class="col-6">
<div class="gallery-img-wrap">
<img src="akagera/mt kigali.jpg" alt="thumbnail">
...
<img src="akagera/Kimironko market.jpg" alt="picture"> <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
</div>
</div>
<div class="col-6">
<div class="gallery-img-wrap active">
<img src="akagera/KGM.webp" alt="banner-image">
<a data-fancybox="gallery-01" href="https://www.youtube.com/watch?v=3G26HVBs3L8">
...
<h3><span>$236<del>$270</del></span>/</h3>
...
<li><i class="bi bi-check-lg"></i> Meals(As specified in the day-by-day section) </li>
</ul>
<ul class="exclud">
...
<li><i class="bi bi-x-lg"></i> Personal items(Souvenirs, travel insurance, visa fees, etc.)	 </li>
<li><i class="bi bi-x-lg"></i> 	Government imposed increase of taxes and/or park fees </li>
<li><i class="bi bi-x-lg"></i> 	Drinks</li>
</ul>
</div>
...
<p>Today’s city tour will take you to visit some of the local city markets, like Kimironko. Here you will experience the sights and sounds of a busy day in Rwanda. The markets are teeming with shops and merchandise and it is very cheap! You will also visit the Genocide Memorial Centre and meet some of the local people who are selling all types of artisanal products. Later in the day your safari will come to an end.

	Your tour starts at 7:30 am (details provided in confirmation email) for an introduction. From there you will head off to the city for a great day of sightseeing. Travel through Nyamirambo to the top of of Mt. Kigali for views of the city and the countryside; sip milk at a milk bar; visit a market where you'll taste fruits; go to a public art walk led by a local artist; refuel with a great Rwandan lunch; stop for the best coffee around; Your tour ends Evening with a drop off at the Genocide Memorial. Our driver will wait and drop you off at your hotel after the visit.
</p>
<ul class="exclud">
