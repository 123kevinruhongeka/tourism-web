...
<h1>
	Embracing Gorilla Trekking While Having A Lifetime Experience And Iconic Culture. </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="https://triprex.egenslab.com"> Home </a></li><li class="active">Embracing Gorilla Trekking While Having A Lifetime Experience And Iconic Culture.</li></ul> </div>
</div>
</div>
</div>
</div>
...
<img loading="lazy" width="1320" height="650" src="akagera/trekking.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" decoding="async" srcset="akagera/trekking 1.jpg 1320w, akagera/trekking 2.jpg 300w, akagera/trekking 3.jpg 600w, akagera/trekking 4.jpg 768w, akagera/trekking 5.jpg 1024w" sizes="(max-width: 1320px) 100vw, 1320px"> <a data-fancybox="gallery-01" href="assets/images/akagera lake.jpg"><i class="bi bi-eye"></i></a>
</div>
</div>
...
<div class="col-6">
<div class="gallery-img-wrap active">
<img src="akagera/trekking.jpg" alt="banner-image">
<a data-fancybox="gallery-01" href="https://youtu.be/y2QSgSWtsLU">
...
<p>
	Embark on a transformative journey through Rwanda with our Kigali City Tour and Gorilla Trekking adventure. Begin in the vibrant capital, exploring its rich history and culture, including poignant landmarks like the Genocide Memorial. Then, delve into the lush jungles of Volcanoes National Park for an awe-inspiring Gorilla Trekking experience. With expert guides, trek through dense foliage to encounter gentle giants in their natural habitat. This journey promises unforgettable encounters with Rwanda's resilience, natural beauty, and majestic wildlife.
	</p>
...
<ul>
<li><i class="bi bi-check-lg"></i>	3 Nights accommodation</li>
<li><i class="bi bi-check-lg"></i> 	Daily breakfast</li>
<li><i class="bi bi-check-lg"></i> 	4 day transport</li>
<li><i class="bi bi-check-lg"></i> 	Professional driver guide</li>
<li><i class="bi bi-check-lg"></i>	gorilla permits</li>
<li><i class="bi bi-check-lg"></i>	City Tour</li>
</ul>
<ul class="exclud">
<li><i class="bi bi-x-lg"></i> 	Shopping/ souvenirs</li>
<li><i class="bi bi-x-lg"></i> 	Tips/ Gratuity</li>
...
<span>Day 01 :</span>AIRPORT PICK UP AND TRANSFER TO HOTEL </button>
</h2>
<div id="collapse0" class="accordion-collapse collapse show" aria-labelledby="heading0" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>Upon your arrival at the airport, you will be met by our professional guide, ready to show you around and introduce you to the land of a thousand hills as you head to the hotel and have a briefing on your next days’ adventure.</p>
<ul class="exclud">
...
<span>Day 02 :</span>CITY TOUR AND DRIVE TO MUSANZE </button>
</h2>
<div id="collapse1" class="accordion-collapse collapse " aria-labelledby="heading1" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>After enjoying breakfast, your guide will be right there to take you around the city as you discover much about the people, culture, history through visiting museums and the city in general. Thereafter we will enjoy lunch in one of the local restaurants to have a taste of the local cuisine, then drive to Musanze.</p>
<ul class="exclud">
<li><i class="bi bi-check-lg"></i> Admire Big Ben, Buckingham Palace And St Paul’s Cathedral</li>
<li><i class="bi bi-check-lg"></i> Chance To Spot Prominent Landmarks Of The City</li>
</ul>
...
<span>Day 03 :</span> GORILLA TREKKING IN VOLCANOES NATIONAL PARK </button>
</h2>
<div id="collapse2" class="accordion-collapse collapse " aria-labelledby="heading2" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>Wakeup to an early morning breakfast and report to the park headquarters for briefing and allocation of Gorilla trekking groups. Later, you will head into the cold and misty forested slopes of Virunga national park for your Gorilla trek. The trek can be anywhere between 2 to 4 hours depending on the movement of the Gorillas and upon finding them, you will be allowed 1 hour to see and take photos after which you exit the forest. Meet your driver / guide drive back to Kigali.</p>
<ul class="exclud">
</ul>
</div>
</div>
...
<span>Day 04 :</span>SOUVENIR SHOPPING AND AIRPORT TRANSFER   </button>
</h2>
<div id="collapse3" class="accordion-collapse collapse " aria-labelledby="heading3" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>This will be more of a day at leisure, depending on your flight departure time. Your guide will always be around, just in case you would want to explore the city more and do some souvenir shopping, then later on take you to the airport.</p>
<ul class="exclud">
</ul>
</div>
</div>
