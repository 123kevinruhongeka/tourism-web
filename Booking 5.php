...
<h1>A Journey Of Touring Beautiful Akagera And Visiting Rwandan Art.
 </h1>
<ul id="breadcrumb-list" class="breadcrumb-list"><li class="breadcrumb-item"><a href="https://triprex.egenslab.com"> Home </a></li><li class="active">A Journey Of Touring Beautiful Akagera And Visiting Rwandan Art.
</li></ul> </div>
</div>
</div>
</div>
...
<div class="col-6">
<div class="gallery-img-wrap">
<img src="akagera/imigongo.jpeg" alt="thumbnail">
...
<img src="akagera/leopard.jpg" alt="picture"> <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
</div>
</div>
<div class="col-6">
<div class="gallery-img-wrap active">
...
<ul>
<li><i class="bi bi-check-lg"></i>Game drive</li>
<li><i class="bi bi-check-lg"></i> 	Park entree fees </li>
...
<li><span><i class="bi bi-check"></i></span> Visit imigongo Art center</li>
</ul>
</div>
<h4>Itinerary</h4>
...
<span>Day 01 :</span>DEPARTING FROM KIGALI AND DRIVE TO AKAGERA NATIONAL PARK </button>
</h2>
<div id="collapse0" class="accordion-collapse collapse show" aria-labelledby="heading0" data-bs-parent="#tourPlan">
<div class="accordion-body">
<p>6:00 AM: Pick-up the guests and transfer to Akagera national park, it is three hours driving from Kigali including stopover, on the way we will enjoy the scenic road surrounded by the green endless rolling hills and we will have some short stopover for the cup of coffee or the restroom use.
	9:00 AM: Arriving at the park head quarter and present some documents such as covid19 negative test result, ID or Passports and processing the payment. 
	10:00 AM: Starting of the game drive, full game driving in Akagera national park, gives you many chances to see different animals including the big five.   
	13:00 PM: You will have a short stopover at new picnic area to have your packed lunch and after we continue our game drive heading to the exit gate. 
	3:00 PM:  Departing from the park exit and drive back to Kigali.
	5-8:00 PM: Arriving back in Kigali and dropping clients at home 
	</p>
<ul class="exclud">
